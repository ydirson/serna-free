...
// 
#ifndef UI_IMPL_QT_LABEL_H_
#define UI_IMPL_QT_LABEL_H_
...
class QtLabel : public QObject, public Item {
public:
    QtLabel(Action* action, PropertyNode* properties);
    virtual ~QtLabel() {};

    virtual String      itemClass() const { return LABEL; }
