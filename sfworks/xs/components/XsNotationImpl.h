...
#ifndef XSNOTATIONIMPL_H_
#define XSNOTATIONIMPL_H_
...
/*! Application-specific information associated with particular
    schema construct.
 */
class XsNotationImpl : public XsNotation {
public:
    ...
    XsNotationImpl(const Origin& origin, const NcnCred& cred);

    XS_OALLOC(XsNotationImpl);
