...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class Vector<String<EquivCode> >;
#else
...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class SharedXcharMap<unsigned char>;
#else
...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class String<EquivCode>;
#else
...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class XcharMap<unsigned char>;
#else
...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class Vector<PackedBoolean>;
#else
...
#else
#ifdef SP_ANSI_CLASS_INST
// XX template class SubstTable<Char>;
#else
