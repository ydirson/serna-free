...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">&lt;h3&gt;关于 Qt&lt;/h3&gt;&lt;p&gt;本程序使用 Qt V%1。&lt;/p&gt;&lt;p&gt;Qt 是一个用于多平台 GUI 应用程序开发的 C++ 工具包。&lt;/p&gt;&lt;p&gt;Qt 提供了跨 MS Windows、 Mac OS X、Linux 和所有主要商用 Unix 版本的单源可移植性。&lt;br&gt;此外，Qt 还可用于嵌入式设备。&lt;/p&gt;&lt;p&gt;Qt 是 Trolltech 产品。 欲了解更多信息，请参阅 &lt;tt&gt;http://www.trolltech.com/qt/&lt;/tt&gt;。&lt;/p&gt;</translation>
    </message>
</context>
<context>
