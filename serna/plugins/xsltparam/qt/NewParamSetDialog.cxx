...
NewParamSetDialog::NewParamSetDialog(QWidget* parent)
    : QDialog(parent)
{
    setupUi(this);
...
void NewParamSetDialog::on_nameEdit__textChanged()
{
    okButton_->setEnabled(!nameEdit_->text().isEmpty());
}

void NewParamSetDialog::on_helpButton__clicked()
{
    helpAssistant().show(DOCTAG(NEW_XSLT_PARAM_SET_D));
}
