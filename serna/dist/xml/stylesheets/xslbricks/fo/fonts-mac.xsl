<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="title.font.family" select="'Verdana, Geneva, sans-serif'" xse:type="string" 
    xse:annotation="Specifies font for titles"/>
  <xsl:param name="dingbat.font.family" select="'Times'"/>
  <xsl:param name="sans.font.family" select="'Verdana, Geneva, sans-serif'" xse:type="string" 
