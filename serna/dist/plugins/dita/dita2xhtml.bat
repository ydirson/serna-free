...
set ANT_ARGS=%ANT_ARGS% -Dargs.transtype=xhtml -Dargs.input="%SERNA_XML_SRCFULLPATH:\=/%"
set ANT_ARGS=%ANT_ARGS% -Doutput.dir="%SERNA_OUTPUT_DIR:\=/%" -Ddita.temp.dir="%SERNA_TEMPDIR:\=/%"
set ANT_ARGS=%ANT_ARGS% -Dargs.xhtml.toc="%SERNA_XML_SRCFILENAME%"
