...
<xsl:param name="headingOutdent">0in</xsl:param>
<xsl:param name="pageMarginLeft">100pt</xsl:param>
<xsl:param name="pageMarginRight">72pt</xsl:param>
<xsl:param name="pageMarginBottom">72pt</xsl:param>
<xsl:param name="pageMarginTop">36pt</xsl:param>
...
<xsl:param name="flowMarginLeft">0in</xsl:param>
...
<xsl:template match="titlePage"> 
  ...
  <fo:block break-after="odd-page" text-align="center" 
     font-size="24pt" >
...
<xsl:template match="front">
  <fo:page-sequence
   ...
   <fo:flow flow-name="xsl-region-body">
     ...
     <fo:block space-before="20pt" break-after="page">
...
<fo:inline>
  <xsl:call-template name="generateDate">
               <xsl:with-param name="showRev">no</xsl:with-param>
  </xsl:call-template>
</fo:inline>
<fo:leader rule-thickness="0pt"/>
              <fo:page-number/>
...
<xsl:choose>
  ...
  <xsl:otherwise>
     <xsl:value-of select="$shortinstitution"/>
  </xsl:otherwise>  
</xsl:choose>
</fo:inline>
</xsl:template>
