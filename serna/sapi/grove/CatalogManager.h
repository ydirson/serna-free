...
// 
#ifndef SAPI_CATALOG_MANAGER_H_
#define SAPI_CATALOG_MANAGER_H_
...
/// Holds instance of the catalog manager 
class SAPI_EXPIMP CatalogManager : public SimpleWrappedObject {
public:
