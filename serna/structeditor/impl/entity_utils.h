...
// 
#ifndef STRUCTEDITOR_IMPL_ENTITY_UTILS_H_
#define STRUCTEDITOR_IMPL_ENTITY_UTILS_H_
...
bool             has_entity_loop(const GroveLib::EntityReferenceStart*, 
                                 const Common::String& name);
void             set_grovebuilder_lock_flags(const Common::Url&,
                                             GroveLib::GroveBuilder*);

#endif // STRUCTEDITOR_IMPL_ENTITY_UTILS_H_
